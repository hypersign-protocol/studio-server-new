...
describe('HidWalletService', () => {
  ...
  it('Should generate Wallet',async ()=>{
    const mnemonictest='swift leader primary gun tool furnace gasp bless kid ceiling maid disagree bike tube enemy wish affair water faith blouse meadow traffic oval stay'    
