...
describe('EdvService', () => {
      ...
      "verificationMethod": [
          {
              ...
              "controller": "did:hid:testnet:z28ScfSszr2zi2Bd7qmNE4mfHX5j8nCwx4DBF6nAUHu4p",
  ...
  const key={
    "privateKeyMultibase": "zrv3qUfaLMV8AJUkfVUJqNUn6C35bWbc2SAeXA2j29BfqZ7CdBjLxkzj1Ej13bb3S9VZn4fh8w7vq7szoC6bLiicrR2",
    "publicKeyMultibase": "z6MkfahfFh8SBaVB8gTpXLL4usDHLezzC6CJkE6Aw48VD7rC"
}
    await service.setAuthenticationKey(key,did.authentication[0],did.controller[0])
