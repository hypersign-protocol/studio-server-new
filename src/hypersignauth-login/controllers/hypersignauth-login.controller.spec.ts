...
import { HypersignauthLoginController } from './hypersignauth-login.controller';
...
describe('HypersignauthLoginController', () => {
  let userController: HypersignauthLoginController;
  let spyUserService: HypersignauthLoginService;
  describe('authenticate() method', () => {
    it('should be register new user', async () => {
      ...
      userController = userModule.get<HypersignauthLoginController>(
        HypersignauthLoginController,
      );
      const req = {};
      const res = {
        status: jest.fn(() => res),
