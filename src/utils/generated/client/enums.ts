...
export function verificationMethodRelationshipsFromJSON(
  object: any,
    ...
    default:
      throw new globalThis.Error(
        'Unrecognized enum value ' +
          object +
          ' for enum VerificationMethodRelationships',
      );
  }
}

export function verificationMethodRelationshipsToJSON(
  object: VerificationMethodRelationships,
): string {
  switch (object) {
...
export function verificationMethodTypesFromJSON(
  object: any,
  ...
  switch (object) {
    ...
    default:
      throw new globalThis.Error(
        'Unrecognized enum value ' +
          object +
          ' for enum VerificationMethodTypes',
      );
  }
}

export function verificationMethodTypesToJSON(
  object: VerificationMethodTypes,
): string {
  switch (object) {
...
export function verificationMethodTypesToNumber(
  object: VerificationMethodTypes,
): number {
  switch (object) {
    case VerificationMethodTypes.Ed25519VerificationKey2020:
...
export function proofTypesFromJSON(object: any): ProofTypes {
  switch (object) {
    ...
    default:
      throw new globalThis.Error(
        'Unrecognized enum value ' + object + ' for enum ProofTypes',
      );
  }
}
