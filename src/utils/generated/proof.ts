...
import {
  ClientSpecType,
  clientSpecTypeFromJSON,
  clientSpecTypeToJSON,
  clientSpecTypeToNumber,
} from './client_spec';
...
export const DocumentProof = {
  encode(
    ...
    if (
      message.clientSpecType !== undefined &&
      message.clientSpecType !== ClientSpecType.CLIENT_SPEC_TYPE_NONE
    ) {
  ...
  fromJSON(object: any): DocumentProof {
    return {
      ...
      proofPurpose: isSet(object.proofPurpose)
        ? globalThis.String(object.proofPurpose)
        : undefined,
      proofValue: isSet(object.proofValue)
        ? globalThis.String(object.proofValue)
        : undefined,
      clientSpecType: isSet(object.clientSpecType)
        ? clientSpecTypeFromJSON(object.clientSpecType)
        : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<DocumentProof>, I>>(
    base?: I,
  ): DocumentProof {
    return DocumentProof.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DocumentProof>, I>>(
    object: I,
  ): DocumentProof {
    const message = createBaseDocumentProof();
