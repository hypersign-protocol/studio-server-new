...
export const MsgRegisterDID = {
  encode(
    ...
    if (
      message.didDocumentProofs !== undefined &&
      message.didDocumentProofs.length !== 0
    ) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.didDocumentProofs!.push(
            DocumentProof.decode(reader, reader.uint32()),
          );
          continue;
        case 3:
          if (tag !== 26) {
  ...
  fromJSON(object: any): MsgRegisterDID {
    return {
      ...
      didDocumentProofs: globalThis.Array.isArray(object?.didDocumentProofs)
        ...
        : undefined,
      txAuthor: isSet(object.txAuthor)
        ? globalThis.String(object.txAuthor)
        : undefined,
    };
  },
  ...
  toJSON(message: MsgRegisterDID): unknown {
    ...
    if (message.didDocumentProofs?.length) {
      obj.didDocumentProofs = message.didDocumentProofs.map((e) =>
        DocumentProof.toJSON(e),
      );
    }
    if (message.txAuthor !== undefined && message.txAuthor !== '') {
  ...
  create<I extends Exact<DeepPartial<MsgRegisterDID>, I>>(
    base?: I,
  ): MsgRegisterDID {
    return MsgRegisterDID.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgRegisterDID>, I>>(
    object: I,
  ): MsgRegisterDID {
    const message = createBaseMsgRegisterDID();
    message.didDocument =
      object.didDocument !== undefined && object.didDocument !== null
        ...
        : undefined;
    message.didDocumentProofs =
      object.didDocumentProofs?.map((e) => DocumentProof.fromPartial(e)) ||
      undefined;
...
export const MsgRegisterDIDResponse = {
  ...
  create<I extends Exact<DeepPartial<MsgRegisterDIDResponse>, I>>(
    base?: I,
  ): MsgRegisterDIDResponse {
    return MsgRegisterDIDResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgRegisterDIDResponse>, I>>(
    _: I,
  ): MsgRegisterDIDResponse {
    const message = createBaseMsgRegisterDIDResponse();
    return message;
...
export const MsgUpdateDID = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateDID>, I>>(
    base?: I,
  ): MsgUpdateDID {
...
export const MsgUpdateDIDResponse = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateDIDResponse>, I>>(
    base?: I,
  ): MsgUpdateDIDResponse {
...
export const MsgDeactivateDID = {
  ...
  fromJSON(object: any): MsgDeactivateDID {
    return {
      didDocumentId: isSet(object.didDocumentId)
        ? globalThis.String(object.didDocumentId)
        : undefined,
      didDocumentProofs: globalThis.Array.isArray(object?.didDocumentProofs)
        ? object.didDocumentProofs.map((e: any) => DocumentProof.fromJSON(e))
        : undefined,
  ...
  create<I extends Exact<DeepPartial<MsgDeactivateDID>, I>>(
    base?: I,
  ): MsgDeactivateDID {
    return MsgDeactivateDID.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgDeactivateDID>, I>>(
    object: I,
  ): MsgDeactivateDID {
    const message = createBaseMsgDeactivateDID();
...
export const MsgDeactivateDIDResponse = {
  ...
  create<I extends Exact<DeepPartial<MsgDeactivateDIDResponse>, I>>(
    base?: I,
  ): MsgDeactivateDIDResponse {
    return MsgDeactivateDIDResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgDeactivateDIDResponse>, I>>(
    _: I,
  ): MsgDeactivateDIDResponse {
    const message = createBaseMsgDeactivateDIDResponse();
    return message;
...
export const MsgRegisterCredentialSchema = {
  encode(
    ...
    if (message.credentialSchemaDocument !== undefined) {
      CredentialSchemaDocument.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.credentialSchemaDocument = CredentialSchemaDocument.decode(
            reader,
            reader.uint32(),
          );
          continue;
        case 2:
          ...
          message.credentialSchemaProof = DocumentProof.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  toJSON(message: MsgRegisterCredentialSchema): unknown {
    const obj: any = {};
    if (message.credentialSchemaDocument !== undefined) {
      obj.credentialSchemaDocument = CredentialSchemaDocument.toJSON(
        message.credentialSchemaDocument,
      );
    }
    if (message.credentialSchemaProof !== undefined) {
      obj.credentialSchemaProof = DocumentProof.toJSON(
        message.credentialSchemaProof,
      );
    }
    if (message.txAuthor !== undefined && message.txAuthor !== '') {
  ...
  create<I extends Exact<DeepPartial<MsgRegisterCredentialSchema>, I>>(
    base?: I,
  ): MsgRegisterCredentialSchema {
    return MsgRegisterCredentialSchema.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgRegisterCredentialSchema>, I>>(
    object: I,
  ): MsgRegisterCredentialSchema {
    const message = createBaseMsgRegisterCredentialSchema();
    message.credentialSchemaDocument =
      object.credentialSchemaDocument !== undefined &&
      object.credentialSchemaDocument !== null
        ? CredentialSchemaDocument.fromPartial(object.credentialSchemaDocument)
        : undefined;
    message.credentialSchemaProof =
      object.credentialSchemaProof !== undefined &&
      object.credentialSchemaProof !== null
...
export const MsgRegisterCredentialSchemaResponse = {
  encode(
    _: MsgRegisterCredentialSchemaResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<MsgRegisterCredentialSchemaResponse>, I>,
  >(_: I): MsgRegisterCredentialSchemaResponse {
    const message = createBaseMsgRegisterCredentialSchemaResponse();
    return message;
  },
};
...
export const MsgUpdateCredentialSchema = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateCredentialSchema>, I>>(
    base?: I,
  ): MsgUpdateCredentialSchema {
    return MsgUpdateCredentialSchema.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgUpdateCredentialSchema>, I>>(
    object: I,
  ): MsgUpdateCredentialSchema {
    const message = createBaseMsgUpdateCredentialSchema();
    message.credentialSchemaDocument =
...
export const MsgUpdateCredentialSchemaResponse = {
  encode(
    _: MsgUpdateCredentialSchemaResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<MsgUpdateCredentialSchemaResponse>, I>,
  >(_: I): MsgUpdateCredentialSchemaResponse {
    const message = createBaseMsgUpdateCredentialSchemaResponse();
    return message;
  },
};
...
export const MsgRegisterCredentialStatus = {
  ...
  create<I extends Exact<DeepPartial<MsgRegisterCredentialStatus>, I>>(
    base?: I,
  ): MsgRegisterCredentialStatus {
    return MsgRegisterCredentialStatus.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgRegisterCredentialStatus>, I>>(
    object: I,
  ): MsgRegisterCredentialStatus {
    const message = createBaseMsgRegisterCredentialStatus();
    message.credentialStatusDocument =
...
export const MsgRegisterCredentialStatusResponse = {
  encode(
    _: MsgRegisterCredentialStatusResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<MsgRegisterCredentialStatusResponse>, I>,
  >(_: I): MsgRegisterCredentialStatusResponse {
    const message = createBaseMsgRegisterCredentialStatusResponse();
    return message;
  },
};
...
export const MsgUpdateCredentialStatus = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateCredentialStatus>, I>>(
    base?: I,
  ): MsgUpdateCredentialStatus {
    return MsgUpdateCredentialStatus.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgUpdateCredentialStatus>, I>>(
    object: I,
  ): MsgUpdateCredentialStatus {
    const message = createBaseMsgUpdateCredentialStatus();
    message.credentialStatusDocument =
...
export const MsgUpdateCredentialStatusResponse = {
  encode(
    _: MsgUpdateCredentialStatusResponse,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<MsgUpdateCredentialStatusResponse>, I>,
  >(_: I): MsgUpdateCredentialStatusResponse {
    const message = createBaseMsgUpdateCredentialStatusResponse();
    return message;
  },
};
...
export interface Msg {
  ...
  RegisterCredentialSchema(
    request: MsgRegisterCredentialSchema,
  ): Promise<MsgRegisterCredentialSchemaResponse>;
  UpdateCredentialSchema(
    request: MsgUpdateCredentialSchema,
  ): Promise<MsgUpdateCredentialSchemaResponse>;
  RegisterCredentialStatus(
    request: MsgRegisterCredentialStatus,
  ): Promise<MsgRegisterCredentialStatusResponse>;
  UpdateCredentialStatus(
    request: MsgUpdateCredentialStatus,
  ): Promise<MsgUpdateCredentialStatusResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  RegisterDID(request: MsgRegisterDID): Promise<MsgRegisterDIDResponse> {
    ...
    return promise.then((data) =>
      MsgRegisterDIDResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  UpdateDID(request: MsgUpdateDID): Promise<MsgUpdateDIDResponse> {
    ...
    return promise.then((data) =>
      MsgUpdateDIDResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  DeactivateDID(request: MsgDeactivateDID): Promise<MsgDeactivateDIDResponse> {
    ...
    return promise.then((data) =>
      MsgDeactivateDIDResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  RegisterCredentialSchema(
    ...
    return promise.then((data) =>
      MsgRegisterCredentialSchemaResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  UpdateCredentialSchema(
    ...
    return promise.then((data) =>
      MsgUpdateCredentialSchemaResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  RegisterCredentialStatus(
    ...
    return promise.then((data) =>
      MsgRegisterCredentialStatusResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  UpdateCredentialStatus(
    ...
    return promise.then((data) =>
      MsgUpdateCredentialStatusResponse.decode(_m0.Reader.create(data)),
    );
  }
}
