...
export const CredentialSchemaDocument = {
  encode(
    ...
    if (message.schema !== undefined) {
      CredentialSchemaProperty.encode(
        message.schema,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.schema = CredentialSchemaProperty.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): CredentialSchemaDocument {
    return {
      ...
      author: isSet(object.author)
        ? globalThis.String(object.author)
        : undefined,
      authored: isSet(object.authored)
        ? globalThis.String(object.authored)
        : undefined,
      schema: isSet(object.schema)
        ? CredentialSchemaProperty.fromJSON(object.schema)
        : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<CredentialSchemaDocument>, I>>(
    base?: I,
  ): CredentialSchemaDocument {
    return CredentialSchemaDocument.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CredentialSchemaDocument>, I>>(
    object: I,
  ): CredentialSchemaDocument {
    const message = createBaseCredentialSchemaDocument();
...
export const CredentialSchemaProperty = {
  ...
  fromJSON(object: any): CredentialSchemaProperty {
    return {
      ...
      properties: isSet(object.properties)
        ? globalThis.String(object.properties)
        : undefined,
  ...
  create<I extends Exact<DeepPartial<CredentialSchemaProperty>, I>>(
    base?: I,
  ): CredentialSchemaProperty {
    return CredentialSchemaProperty.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CredentialSchemaProperty>, I>>(
    object: I,
  ): CredentialSchemaProperty {
    const message = createBaseCredentialSchemaProperty();
...
export const CredentialSchemaState = {
  ...
  create<I extends Exact<DeepPartial<CredentialSchemaState>, I>>(
    base?: I,
  ): CredentialSchemaState {
    return CredentialSchemaState.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CredentialSchemaState>, I>>(
    object: I,
  ): CredentialSchemaState {
    const message = createBaseCredentialSchemaState();
    message.credentialSchemaDocument =
