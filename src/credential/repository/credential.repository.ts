...
export class CredentialRepository{
    constructor(
        @InjectModel(Credential.name) private readonly credentialModel:Model<CredentialModel>
    ){}


    async findOne(credentialFilterQuery: FilterQuery<CredentialModel>): Promise<CredentialModel> {
        return this.credentialModel.findOne(credentialFilterQuery);
      }
      async find(credentialFilterQuery: FilterQuery<CredentialModel>): Promise<CredentialModel[]> {
      ...
      async findOneAndUpdate(
        ...
        return this.credentialModel.findOneAndUpdate(credentialFilterQuery, credential, { new: true });
      }
}